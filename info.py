...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002159223285')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://charliebots097:ZMWBYWWBJQlVihk0@cluster0.nacke.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "charliebots097")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Zone_files')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://sleepy-maurizia-akonbots-8c26fd97.koyeb.app/")
