...
PICS = (environ.get('PICS', 'https://graph.org/file/88693b0abe1481e5a11a9.jpg')).split() #SAMPLE PIC
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5469498838 5949300501').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002004346552 -1002046685711').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002137388056') # give your force subscribe channel id here else leave it blank
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://private-janice-jaat1-60e20ef7.koyeb.app/")
