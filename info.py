...
auth_channel = environ.get('AUTH_CHANNEL', '-1002215653461') # give your force subscribe channel id here else leave it blank
...
SHORTLINK_API = environ.get('SHORTLINK_API', '93d31da013e4db197b7626a5c43193ad6935d993')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://teekam-ec01bbc2.koyeb.app/")
